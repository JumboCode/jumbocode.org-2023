...
export default function Header() {
    ...
    return (
        <div className={classNames(cx('base'))}>
            <p className={classNames(cx('text'))}>We design, develop, and ship high-quality bespoke software at no cost for nonprofit organizations whose missions we believe in.</p>
